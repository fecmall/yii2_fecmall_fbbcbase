...
namespace fbbcbase\app\appbdmin\modules\Cms\block\homepage;
...
class Manager extends AppbdminbaseBlockEdit implements AppbdminbaseBlockEditInterface
{
    ...
    public function init()
    {
        ...
        $this->_key = Yii::$service->systemConfig->homePageKey;
        if (!($this instanceof AppbdminbaseBlockEditInterface)) {
         ...
         // 需要配置
        $this->_saveUrl = CUrl::getUrl('cms/homepage/managereditsave');
    ...
    public function getEditArr()
    {
        ...
        return [
            ...
            [
                'label'  => Yii::$service->page->translate->__('skus'),
                'name' => 'skus',
                'display' => [
                    'type' => 'inputString',
                ],
