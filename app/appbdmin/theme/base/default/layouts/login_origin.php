...
<style>
 ...
 <div id="login">
		<div id="login_header">
         ...
         <div id="login_footer">
             Copyright &copy; 2016 <a style="text-decoration:none" target="_blank" href="http://www.fecshop.com">www.fecshop.com</a> <?= Yii::$service->page->translate->__('Login Fecshop Bdmin'); ?>Inc. All Rights Reserved.
         </div>
