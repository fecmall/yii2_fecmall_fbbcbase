...
class BdminUser extends Service
{
    ...
    protected $_modelName = '\fbbcbase\models\mysqldb\BdminUser';
    protected $_model;

    protected $_userFormModelName = '\fbbcbase\models\mysqldb\bdminUser\BdminUserForm';
    protected $_userFormModel;
    
    protected $_userPassResetModelName = '\fbbcbase\models\mysqldb\bdminUser\BdminUserResetPassword';
